...
# calculating the slope of the line passing through both the ball and the goal
                m= (goal[1]-waypoint[1])/(goal[0]-waypoint[0])
                distance_behind_ball=0.3
                point_behind_ball_x= waypoint[0]- distance_behind_ball
                point_behind_ball_y= m*(point_behind_ball_x-waypoint[0])+waypoint[1]
    ...
    # Calculate orientation difference (normalized to [-pi, pi])
                ...
                # Get current position and orientation
                    ...
                    direction = [(point_behind_ball_x - position[0]), (point_behind_ball_y - position[1])]
                    ...
                    print(f"Target orientation: {desired_orientation:.2f}")
                    print(f"Orientation Difference: {orientation_difference:.2f}")
                    print(f"Distance to waypoint: {distance:.2f}")
                    print(f"Waypoint= {direction[0]:.2f} , {direction[1]:.2f}")
                    ...
                    if abs(orientation_difference) > 0.05:
                        ...
                        forward_speed = 0.3  # Adjust forward speed
                        if distance > distance_behind_ball:
