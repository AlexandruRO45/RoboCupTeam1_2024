    ...
    def run(self):
            ...
            if robot.step(self.timeStep) == -1:
                ...
                while robot.step(timestep) != -1:
                   ...
                   # print(f"Formation coordinates: {formation}")
                    print(f"Robot A Waypoint coordinates: {waypoint}")      
        ...
        # Calculate orientation difference (normalized to [-pi, pi])
                ...
                # Get current position and orientation
                    ...
                    print(f"Robot A Target orientation: {desired_orientation:.2f}")
                    print(f"Robot A Orientation Difference: {orientation_difference:.2f}")
                    print(f"Robot A Distance to waypoint: {distance:.2f}")
