...
class Nao (Robot):
                ...
                while robot.step(timestep) != -1:
                    ...
                    if receiver.getQueueLength() > 0:
                        ...
                        if len(received_numbers) == 9:
                            ...
                            waypoint = received_numbers[6:]

                        elif len(received_numbers) == 4 and received_numbers[0]== 3 :
    ...
    # Get current position and orientation
                    ...
                    # Calculate direction to the waypoint (x, y tensor)
                    direction = [waypoint[0] - position[0], waypoint[2] - position[2]]
                
                    # Calculate the targeted orientation
                    ...
                    # Turn left until desired orientation is reached
                    if orientation_difference > 0.05:
                        self.startMotion(self.turnLeft60)
                        print("Turning left")
                        # Update orientation and difference
                        orientation = imu.getRollPitchYaw()
                        orientation_difference = desired_orientation - orientation[2]
                    else:
                        ...
                        if distance > 0.5:
                            ...
                            print(f"Moving to the Ball at coords {GetBall}")
                            position = gps.getValues()
                            orientation = imu.getRollPitchYaw()
                                
                                
                                    # Calculate direction to the waypoint (x, y tensor)
                            direction = [GetBall[0] - position[0], GetBall[2] - position[2]]
