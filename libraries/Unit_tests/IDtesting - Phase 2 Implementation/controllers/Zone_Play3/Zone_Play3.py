    ...
    def run(self):
            ...
            if robot.step(self.timeStep) == -1:
                ...
                while robot.step(timestep) != -1:
                   ...
                   # print(f"Formation coordinates: {formation}")
                    print(f"Robot c Waypoint coordinates: {waypoint}")      
        ...
        # Calculate orientation difference (normalized to [-pi, pi])
                ...
                # Get current position and orientation
                    ...
                    print(f"Robot c Target orientation: {desired_orientation:.2f}")
                    print(f"Robot c Orientation Difference: {orientation_difference:.2f}")
                    print(f"Robot c Distance to waypoint: {distance:.2f}")
                    ...
                    if abs(orientation_difference) > 0.05:
                        ...
                        if orientation_difference > 0:
                            ...
                            print("Robot c Turning left")
                        else:
                            self.startMotion(self.turnRight20)  # Turn right
                            print("Robot c Turning right")
                    else:
