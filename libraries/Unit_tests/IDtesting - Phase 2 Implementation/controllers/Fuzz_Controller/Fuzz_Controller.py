...
class Nao (Robot):
    ...
    def loadMotionFiles(self):
        ...
        self.turnLeft20 = Motion('../../motions/TurnLeft10.motion')
        self.turnRight20 = Motion('../../motions/TurnRight10.motion')
        ...
        while True:
            ...
            # Calculate orientation difference (normalized to [-pi, pi])
                    ...
                    # Get current position and orientation
                        ...
                        engine.input_variable("input1").value = orientation_difference
                        engine.process()
